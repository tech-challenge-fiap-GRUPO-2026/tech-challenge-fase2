...
Mapear os pontos do problema como as capitais dos 26 estados e do Distrito Federal em um plano 2D simples.
...
O arquivo segue o mesmo formato de entregas do projeto atual, entao pode ser usado direto com `--deliveries-file`.
